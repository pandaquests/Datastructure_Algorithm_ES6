...
\end{examplei}
{\bf Stichwörter:} Array, Suche, Sliding Window, Zeiger, Pointer

\paragraph{Vorgehensweise}
% Das Problem ist, das Maximum zu finden ohne erneut die Zahlen im Fenster durchzugehen.
\begin{enumerate} 

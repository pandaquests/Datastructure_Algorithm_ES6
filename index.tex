...
\end{lstlisting}
\section{Stack}
Ein Stack ist wie ein Stapel von Papier. Man legt ein Blatt Papier oben auf den Stapel auf und wenn man eins wegnehmen will, dann kann man dieses nur von oben entfernen. Dieses Prinzip nennt sich "Last-in-first-out" (LIFO). 
...
\begin{itemize} 
	\item push(item): Fügt ein Element an der obersten Stelle des Stacks ein.
	...
	\item peek(): Gibt den Wert zurück, der ganz oben auf dem Stack ist ohne diesen Wert vom Stack zu entfernen.
	\item empty (function): Returns string representation of list. Wenn der Stack leer ist, wird \lstinline|undefined| zurück gegeben.
	\item empty(): Überprüft, ob der Stack leer ist oder nicht. Er gibt \lstinline|true| zurück, dann und auch nur dann der Stack leer ist. Andernfalls gibt er \lstinline|false| zurück.
...
Nachfolgend werden wir die \lstinline|Stack| Klasse erstellen. Die gesamte Klasse inklusive den Tests zu dieser Klasse kann unter meinem GitHub Repo angeschaut werden. Die ganze Klasse findet ihr hier: \url{https://github.com/pandaquests/Datastructure_Algorithm_ES6/blob/master/code/datastructures/List.js}
